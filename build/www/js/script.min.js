...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziPope", src: "./img/bonzi/pope.png" },
        ...
        { id: "MsPeedy", src: "./img/bonzi/peedy.png" },
        { id: "bonziPink", src: "./img/bonzi/pink.png" },
        { id: "topjej", src: "./img/misc/topjej.png" },
        { id: "Megatron", src: "./img/bonzi/megatron.png" },
        { id: "Peter", src: "./img/bonzi/peter.png" },
        { id: "Scary", src: "./img/bonzi/scary.png" },
        { id: "Nazar", src: "./img/bonzi/nazar.png" },
        { id: "ScaryRed", src: "./img/bonzi/scaryred.png" },
        { id: "Girly", src: "./img/bonzi/girly.png" },
        { id: "bonzicoin", src: "./img/collectibles/bonzicoin/bonzicoin.png" },
    ]),
        loadQueue.on(
            "fileload",
            function (a) {
...
function login() {
	...
	var audio = new Audio('./sfx/startup.mp3');
    audio.play();
 }
function errorFatal() {
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("updateAll", function (a) {
            $("#page_login").hide(), (usersPublic = a.usersPublic), usersUpdate(), BonziHandler.bonzisCheck(), BonziHandler.showBonzicoin();
        }),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            (this.x = e.x * this.rng()),
                ...
                setTimeout(function() {
                    var audio = new Audio('./sfx/jump_off.mp3');
                    audio.play();
                }, 1000);
        }
        return (
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope","peedy", "megatron", "peter", "scary", "nazar", "scaryred", "girly", "numberblocks", "sprunkicoka", "sprunkicokahorror", "sprunkigray", "sprunkigrayhorror", "sprunkipeppie", "sprunkipeppiehorror", "unknownblack", "unknownwhite"], b = 0; b < a.length; b++) {
                        var c = a[b],
                ...
                (this.initBonzicoin = function () {
                    var frameData = {};
                    for (var i = 0; i < 60; i++) {
                        var frameNum = String(i).padStart(4, '0');
                        frameData["0001 " + i + ".png"] = i;
                    }
                    
                    var bonzicoinSpriteSheet = new createjs.SpriteSheet({
                        images: ["./img/collectibles/bonzicoin/bonzicoin.png"],
                        frames: { width: 256, height: 256, count: 60 },
                        animations: {
                            spin: { frames: Array.from({length: 60}, (_, i) => i), speed: 17/60 }
                        }
                    });
                    
                    this.bonzicoinSprite = new createjs.Sprite(bonzicoinSpriteSheet, "spin");
                    this.bonzicoinSprite.scaleX = this.bonzicoinSprite.scaleY = 0.25;
                    
                    this.bonzicoinStage = new createjs.Stage("bonzicoin_canvas");
                    this.bonzicoinStage.addChild(this.bonzicoinSprite);
                    
                    createjs.Ticker.addEventListener("tick", this.bonzicoinStage);
                }),
                (this.showBonzicoin = function () {
                    if (!document.getElementById("bonzicoin_canvas")) {
                        $("#bonzicoin_container").html('<canvas id="bonzicoin_canvas" width="64" height="64"></canvas>');
                        this.initBonzicoin();
                    }
                    $("#bonzicoin_container").show();
                }),
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "topjej","MsPeedy","BonziPope","Megatron","bonzicoin"];
